...
class CrossTileSymbolLayerIndex {
    ...
    addTile(tileID: OverscaledTileID, symbolInstances: Array<SymbolInstance>) {
        ...
        const oldTileIndex = this.indexes[tileID.overscaledZ] && this.indexes[tileID.overscaledZ][tileID.id];
        if (oldTileIndex) {
        ...
        this.indexes[tileID.overscaledZ][tileID.id] = tileIndex;
    }

    removeTile(tileID: OverscaledTileID) {
        const removedIndex = this.indexes[tileID.overscaledZ][tileID.id];

        delete this.indexes[tileID.overscaledZ][tileID.id];
