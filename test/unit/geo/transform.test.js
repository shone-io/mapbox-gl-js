...
test('transform', (t) => {
    ...
    test('coveringTiles', (t) => {
        ...
        transform.zoom = 1;
        t.deepEqual(transform.coveringTiles(options), [
                new OverscaledTileID(1, 0, new CanonicalTileID(1, 0, 0)),
                new OverscaledTileID(1, 0, new CanonicalTileID(1, 1, 0)),
                new OverscaledTileID(1, 0, new CanonicalTileID(1, 0, 1)),
                new OverscaledTileID(1, 0, new CanonicalTileID(1, 1, 1))]);

        transform.zoom = 2.4;
        t.deepEqual(transform.coveringTiles(options), [
                new OverscaledTileID(2, 0, new CanonicalTileID(2, 1, 1)),
                new OverscaledTileID(2, 0, new CanonicalTileID(2, 2, 1)),
                new OverscaledTileID(2, 0, new CanonicalTileID(2, 1, 2)),
                new OverscaledTileID(2, 0, new CanonicalTileID(2, 2, 2))]);

        transform.zoom = 10;
        t.deepEqual(transform.coveringTiles(options), [
                new OverscaledTileID(10, 0, new CanonicalTileID(10, 511, 511)),
                new OverscaledTileID(10, 0, new CanonicalTileID(10, 512, 511)),
                new OverscaledTileID(10, 0, new CanonicalTileID(10, 511, 512)),
                new OverscaledTileID(10, 0, new CanonicalTileID(10, 512, 512))]);
