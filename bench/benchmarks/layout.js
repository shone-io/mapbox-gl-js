...
module.exports = class Layout extends Benchmark {
    ...
    tileIDs(): Array<OverscaledTileID> {
        return [
            new OverscaledTileID(12, 0, new CanonicalTileID(12, 655, 1583)),
            new OverscaledTileID(8, 0, new CanonicalTileID(8, 40, 98)),
            new OverscaledTileID(4, 0, new CanonicalTileID(4, 3, 6)),
            new OverscaledTileID(0, 0, new CanonicalTileID(0, 0, 0))
        ];
    }
